...
/// launch infrastructure without repeating the parameter list.
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct CudaKernelSignature {
    /// PTX entry-point name.
    pub name: &'static str,
    /// Ordered source parameters and their launch-packet representation.
    pub parameters: &'static [CudaKernelParameter],
}

/// One source parameter in a [`CudaKernelSignature`].
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct CudaKernelParameter {
    /// Parameter name in the Rust kernel declaration.
    pub name: &'static str,
    /// How the parameter is represented in the CUDA launch packet.
    pub kind: CudaKernelParameterKind,
}

/// Launch-packet representation selected by `#[cuda_module]`.
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum CudaKernelParameterKind {
