...
//! Generated intrinsic target tests: `packed_atomic` intrinsics.

use super::super::*;

#[test]
fn packed_atomic_add_f16x2_target_matches_the_catalog() {
...
#[test]
fn packed_atomic_add_bf16x2_target_matches_the_catalog() {
